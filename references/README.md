...
| File | Hardware | Notes |
|---|---|---|
| `TNS-2SXM2-4P54-300G-spec-v1.3.pdf` | TNS-2SXM2-4P54 dual-SXM2 NVLink baseboard | 2x SXM2 V100, NVLink NVHS 300GB/s, 4x SlimSAS SFF-8654 PCIe x16 uplink to the host. Vendor spec sheet Ver 1.3. Original filename: `TNS-2SXM2-4P54+300G+规格书+Ver1.3.pdf` |
